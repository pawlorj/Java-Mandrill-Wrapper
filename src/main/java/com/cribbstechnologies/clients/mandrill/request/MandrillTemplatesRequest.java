...
public class MandrillTemplatesRequest {
	...
	public TemplateResponse addTemplate(MandrillRequestWithCode addRequest) throws RequestFailedException, InvalidResponseException {
		return (TemplateResponse) request.postRequest(addRequest, ServiceMethods.Templates.ADD, TemplateResponse.class);
	}
	
	public TemplateResponse getTemplateInfo(MandrillRequestWithName infoRequest) throws RequestFailedException, InvalidResponseException {
		return (TemplateResponse) request.postRequest(infoRequest, ServiceMethods.Templates.INFO, TemplateResponse.class);
	}
	
	public TemplateResponse updateTemplate(MandrillRequestWithCode updateRequest) throws RequestFailedException, InvalidResponseException {
		return (TemplateResponse) request.postRequest(updateRequest, ServiceMethods.Templates.UPDATE, TemplateResponse.class);
	}
	
	public TemplateResponse deleteTemplate(MandrillRequestWithName deleteRequest) throws RequestFailedException, InvalidResponseException {
		return (TemplateResponse) request.postRequest(deleteRequest, ServiceMethods.Templates.DELETE, TemplateResponse.class);
	}
	
	public TemplateListResponse getTemplates(BaseMandrillRequest listRequest) throws RequestFailedException, InvalidResponseException {
